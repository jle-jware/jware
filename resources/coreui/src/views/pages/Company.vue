                    ...
                    <div class="card mx-4">
                        <div class="card-body p-4">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" :class="errors.has('name') ? 'form-control is-invalid':'form-control'" v-validate="'required'" name="name" v-model="company.name" placeholder="Enter Company Name">
                            </div>
                            ...
                            <button type="button" @click.prevent="submit" class="btn btn-block btn-success">Create Company</button>
                        </div>
                    </div>
                </div>
            </div>
