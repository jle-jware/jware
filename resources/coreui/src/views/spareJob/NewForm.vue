                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-sm-3">
                                    ...
                                    <multiselect v-model="selectedSpare"  :options="spares" @select="onSelectSpare" track-by="id" label="name" placeholder="Select Spare"
    ...
    export default {
        ...
        data() {
            return {
                ...
                edit: false,
                selectedSpare: { id: null, name: 'Select Spare',current_stock:0 },
                job:{},
                address: '',
                spare:{
                    assetModel:{}
        ...
        methods: {
            ...
            fetchJobById(id) {
                this.$http.get(`/api/job/${id}`,
                    ...
                    .then(response => {
                        ...
                        this.fetchSpareByAsset(this.job.asset.asset_model_id)
            ...
            fetchSpareByAsset(id) {
                this.$http.get(`/api/asset/${id}/spares`, {
                    headers: {
                        Authorization: `Bearer ${this.$store.state.token}`
                    }
                })
